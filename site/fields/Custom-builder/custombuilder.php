...
class CustombuilderField extends StructureField {

  static public $assets = array(
    "css" => array('builder.css', "custom.css"),
    "js" => array('jquery-ui.min-resizable.js', 'custom.js' ),
  );
  ...
  public function url($action) {
    return purl($this->model(), 'field/' . $this->name() . '/custombuilder/' . $action);
  }
